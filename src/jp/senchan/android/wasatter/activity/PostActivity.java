...
public class PostActivity extends Activity {
		...
		if (post_btn != null) {
			post_btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					EditText status = (EditText) PostActivity.this
							.findViewById(R.id.post_status_text);
					CheckBox wassr = (CheckBox) PostActivity.this
							.findViewById(R.id.check_post_wassr);
					CheckBox twitter = (CheckBox) PostActivity.this
							.findViewById(R.id.check_post_twitter);
	...
	protected void onActivityResult(final int requestCode,
		...
		if(image != null){
			...
			e.printStackTrace();
			Toast.makeText(PostActivity.this, "画像の添付に失敗しました。サイズオーバーです…。", Toast.LENGTH_SHORT).show();
		}
	}
}
