...
import jp.senchan.android.wasatter.util.StatusItemComparator;
import jp.senchan.android.wasatter.util.TwitterClient;
	...
	protected ArrayList<WasatterItem> doInBackground(String... param) {
		...
		case TaskReloadTimeline.MODE_TIMELINE:
			try {
				...
				publishProgress(Wasatter.WASSR, String.valueOf(e
						.getStatusCode()));
			}
			...
			try {
				...
				publishProgress(Wasatter.TWITTER, String.valueOf(e
						.getStatusCode()));
			}
			break;
		...
		case TaskReloadTimeline.MODE_CHANNEL:
			try {
				...
				publishProgress(Wasatter.WASSR, cause);
			}
			break;
		}
		return ret;
