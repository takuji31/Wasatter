...
public class ItemPostLoader extends AsyncTaskLoader<Boolean> {
	...
	public ItemPostLoader(Context context,WasatterApiClient client, String body, String imagePath, String replyId) {
		super(context);
		mClient = client;
		mBody = body;
