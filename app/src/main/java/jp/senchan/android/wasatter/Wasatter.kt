...
object Wasatter : Application {
    const val AGENT = "Wasatter for Android"
    const val VIA = "Wasatter"
    ...
    const val ODAI_DATE_FORMAT = "yyyy/MM/dd"
    const val REPLY = "reply"
    const val OAUTH_KEY = "5WURvsXWy6pwsFyJvR7Yw"
    const val OAUTH_SECRET = "Ya9SKf2G0iPDRzrGeFrwTVe4eIgsjO8t4chCQl62vs"
    const val WASSR_OAUTH_REQUEST = "http://wassr.jp/auth/?app_key=9jJkQds39nOUjHFPZ6LgpbE8cuXVoJOS&sig=bed07c761de34c88af1a3cf1fd03b60ce1235715"
